...
with st.sidebar:
    ...
    <div style="padding:4px 8px 12px; text-align:center;">
        ...
        <div style="margin-top:10px; display:flex; justify-content:center; gap:6px;">
          ...
          <span style="background:{'#0a1a2a' if _DARK else '#f5f0ff'};border:1px solid {'#1a4a6a' if _DARK else '#a855f7'};color:#a855f7;
                       border-radius:20px;padding:2px 10px;font-size:0.65rem;
                       letter-spacing:0.08em;">Memory Forensics</span>
        </div>
    </div>
    ...
    st.markdown("""
    <div style="text-align:center;font-size:0.65rem;color:#555;letter-spacing:0.08em;">
        GhostTrace &nbsp;&middot;&nbsp; Memory Forensics &amp; Threat Intelligence
    </div>
    """, unsafe_allow_html=True)
...
tab_overview, tab_proc, tab_mal, tab_net, tab_ps, tab_dll, tab_hdl, tab_lolbas, tab_dyn, tab_score, tab_tl, tab_chat, tab_report, tab_results, tab_ctf = tabs
                ...
                try:
                    ...
                    def _footer(canvas, doc):
                        ...
                        canvas.drawCentredString(
                            A4[0] / 2, 1.1 * cm,
                            f"GhostTrace v2.0  ·  Memory Forensics Platform  ·  Case {_case_id2}  ·  Page {doc.page}"
                        )
                    ...
                    doc2 = SimpleDocTemplate(
                        ...
                        author="GhostTrace Memory Forensics Platform",
                    ...
                    cov_data = [
                        ...
                        [Spacer(1, 8*mm)],
                        [Paragraph("GhostTrace v2.0 — Memory Forensics & Threat Intelligence Platform", _ps("CCD", fontSize=9, textColor=LGRAY, alignment=TA_CENTER, leading=13))],
                        [Paragraph("Digital Forensics & Cybersecurity", _ps("CCU", fontSize=8, textColor=_rlc.HexColor("#7c3aed"), alignment=TA_CENTER, leading=12))],
                        [Spacer(1, 6*mm)],
                    ...
                    story2 += [
                        ...
                        Spacer(1, 2*mm),
                        Paragraph(f"GhostTrace v2.0  ·  Memory Forensics Platform", S_FTR),
                    ]
